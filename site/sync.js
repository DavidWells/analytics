...
const CUSTOM_MAPPING = {
  ...
  '@analytics/custify': resolve('custify.md'),
  '@analytics/google-analytics-v3': resolve('google-analytics-v3.md'),
  ...
  '@analytics/url-utils': path.resolve(UTILS_DOC_PATH, 'url.md'),
