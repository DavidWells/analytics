...
The `@analytics/crazy-egg` package works in [the browser](#browser). To use, install the package, include in your project and initialize the plugin with [analytics](https://www.npmjs.com/package/analytics).
...
The `@analytics/crazy-egg` package works in [the browser](#browser)
